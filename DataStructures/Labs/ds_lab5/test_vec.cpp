...
int main() {
  ...
  v9.print();
  cout << "Testing remove_matching_elements, the element to remove is 5"<<endl;

  remove_matching_elements(v9, 5);
  for (int n = 0; n < v9.size(); n++) {
    cout << v9[n]<<" ";
  }
  v9.print();
  cout << "\n5 shoudl be removed from the vector"<<endl;
