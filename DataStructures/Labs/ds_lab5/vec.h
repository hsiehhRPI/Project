...
template <class T>int remove_matching_elements(Vec<T>& v, T t) {
  int matchCount = 0;
  //Count the number of elements needed to be deleted
...
std::cout << "\nSize of vector: "<< m_size<< "Number of arrays allocated: "<< m_alloc << std::endl;
